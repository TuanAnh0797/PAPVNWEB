<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlanPAN.aspx.cs" Inherits="PAPVN.RealTimePlan" %>
            ...
            <div class="chart" style="padding: 5px;">
                <div style="background-color: white; padding: 5px">
                    <div style="display: flex; align-items: center; justify-content: center">
                        <h1 style="font-weight: 600">Biểu đồ sản lượng PAN theo model</h1>
                    </div>
            ...
            <div class="row">
                <div class="chart col-sm-4" style="padding: 5px;">
                    <div style="background-color: white; padding: 5px; margin: 0px 0px 0px 5px">
                        <div style="display: flex; align-items: center; justify-content: center">
                            <h2 style="font-weight: 600">Biểu đồ tỉ lệ OK/NG PAN</h2>
                        </div>
                        <div class="chart-container">
                ...
                <div class="chart col-sm-8" style="padding: 5px;">
                    <div style="background-color: white; padding: 5px; margin: 0px 5px 0px 0px">
                        <div style="display: flex; align-items: center; justify-content: center">
                            <h2 style="font-weight: 600">Biểu đồ tổng sản lượng PAN</h2>
                        </div>
                        <div class="chart-container">
