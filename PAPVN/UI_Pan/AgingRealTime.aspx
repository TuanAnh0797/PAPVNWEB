        ...
        <div class="row">
            <div class="col-3 " style="padding: 5px">
                ...
                <div class="card" style="background-color: white">
                    ...
                    <h3 class="card-header bg-primary text-white p-1" style="color: white; background-color: #eb940a; text-align: center; font-weight: bold">Lịch sử 50 tủ gần nhất</h3>
            ...
            <div class="col">
                <div class="row" style="padding-left: 3px">
                    <div class="chart col-4" style="padding: 5px;">
                        <div class="card" style="background-color: white">
                            <h3 class="card-header bg-warning text-dark text-center p-1" style="font-weight: 600">Biểu đồ tỉ lệ OK/NG</h3>
                    ...
                    <div class="chart col" style="padding: 5px;">
                        <div  class="card" style="background-color: white">
                            ...
                            <h3 class="card-header bg-success text-white text-center p-1" style="color: white; background-color: #198754; font-weight: 600">Biểu đồ số lượng tủ OK/NG/PENDING</h3>
