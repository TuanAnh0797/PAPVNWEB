<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UploadPlanCa1.aspx.cs" Inherits="PAPVN.UploadPlanCa1" %>
    ...
    <script>
        ...
        function UpdateDateTimePlan() {
            if (isUpdateDateTimePlan == 0) {
                ...
                if (datetimefrom.length < 10 || datetimeto.length < 10) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '/WebServiceModifyPlan.asmx/UpdateDateTimePlanCa1',
        ...
        function MonitorSpecial(elm) {
            if (isMonitorSpecial == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/WebServiceModifyPlan.asmx/MonitorSpecialCa1',
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'json',
