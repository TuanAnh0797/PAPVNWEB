...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="content" style="background-color:#dddbdb; padding-left:2px; padding-right:2px">
        ...
        <script>
            ...
            var currentRequest2;
            async function LoadDataForBarchartMonitor() {
                try {
        ...
        <%--$('#<%= modelplan.ClientID %>').on('change', function () {
            ...
            //setInterval(loadDataForLineChart, 300000);
            var tmr1 = setInterval(LoadDataForBarchart, 300000);

            window.onbeforeunload = function () {
                clearInterval(tmr1);
            };
       // setInterval(LoadDataForBarchartMonitor, 300000);
        </script>
