...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row" style="background-color: #fffefe; border-radius: 8px;">
         ...
         <div class="col-sm-3" style="margin-top: 5px; margin-bottom: 5px">
             <asp:Button type="button" Text="Upload" OnClick="btn_Import_Click" runat="server" name="btn_Import" Style="font-size: 20px; font-weight: 600; padding: 5px" class="btn btn-outline-primary btn-block "></asp:Button>
         </div>
