<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UploadPlanCa3.aspx.cs" Inherits="PAPVN.UploadPlanCa3" %>
    ...
    <div class="card">
        <div class="card-header">
            <div class="text-center">
                <h1 style="font-weight: bold">Kế hoạch sản xuất ngày <%=datenow%> Ca 3</h1>
            </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
