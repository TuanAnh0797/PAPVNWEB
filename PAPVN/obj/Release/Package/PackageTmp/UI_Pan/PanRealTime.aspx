<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PanRealTime.aspx.cs" Inherits="PAPVN.UI_Pan.PanRealTime" %>
    ...
    <div class="m-2">
        ...
        <div class="form-group row mb-0 justify-content-end align-items-center">
            <h1 class="text-right mr-4"
                style="font-weight: 700; color: #0d47a1; text-transform: uppercase; letter-spacing: 2px; text-shadow: 1px 1px 3px rgba(0,0,0,0.1);">DASHBOARD SẢN LƯỢNG CÔNG ĐOẠN PAN
            </h1>
